#this is exception file , in this file we have written the custom exception for our project
...
def error_message_detail(error,error_detail:sys):
    ...
    _,_,exc_tb=error_detail.exc_info() #all the info abut the error will store in this variable
